...
/**
 * @class S32CanClientRaw
 * @brief The class which defines a S32 CAN client which inherites CanClient.
 */
class S32CanClientRaw : public CanClient {
 public:
  /**
   * @brief Initialize the S32 CAN client by specified CAN card parameters.
